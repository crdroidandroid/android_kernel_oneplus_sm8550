...
#define OPLUS_WD_KLOG_ERROR(fmt, args...)                               \
	do {                                                                \
		printk(KERN_ERR "[OPLUS_WD] %s: " fmt, __func__, ##args);       \
	} while (0)
#define OPLUS_WD_KLOG_WARNING(fmt, args...)                             \
	do {                                                                \
	printk(KERN_WARNING "[OPLUS_WD] %s: " fmt, __func__, ##args);       \
	} while (0)
#define OPLUS_WD_INFO(fmt, args...)                                     \
	do {                                                                \
		printk(KERN_INFO "[OPLUS_WD] %s: " fmt, __func__, ##args);      \
	} while (0)
...
{
	OPLUS_WD_KLOG_WARNING("init_oplus_watchdog !\n");
...
{
	int ret = 0;
	OPLUS_WD_KLOG_WARNING("oplus_wd_init start!\n");
